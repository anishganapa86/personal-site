          ...
          <div>
            ...
            <Reveal delay={0.2} y={36} blur={12} duration={1.0}>
              <p className="mt-8 text-black" style={{ fontSize: 'clamp(21px, 3.4vw, 32px)', lineHeight: 1.25, fontWeight: 400, maxWidth: '22ch' }}>
                I'm a high schooler working where microbiology meets tech.
              </p>
            </Reveal>
            <Reveal delay={0.32} y={28} blur={10}>
              <p className="mt-6 text-black" style={bodyStyle}>
                ...
                and machine learning. Honestly, I started this whole thing because I thought
                Batman's tech was always super sick.
              </p>
            </Reveal>
            <Reveal delay={0.44} y={22} blur={8} duration={0.85}>
              <p className="mt-5 text-black" style={bodyStyle}>
                Currently a researcher at UC Merced and MIT Critical Data, and a research
                assistant at the USC Alfred E. Mann School of Pharmacy and Pharmaceutical
                Sciences. Previously at the University of Nevada, Las Vegas. Based in
                Henderson, Nevada.
              </p>
            </Reveal>
          </div>
      ...
      <Section id="experience" index="03" label="Currently">
        ...
        <div className="mt-10">
          <UpdateCard
            ...
            title="AutoLyse"
            status="In progress"
            body="An independent research project. Details to follow once the work is further along."
          />
        </div>
      </Section>
