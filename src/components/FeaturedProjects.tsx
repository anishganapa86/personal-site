...
export default function FeaturedProjects() {
  return (
    <div className="mt-12 grid grid-cols-1 gap-4 md:grid-cols-2">
      ...
      {/* Fibroid knowledge graph - white card, network visual */}
      <Reveal delay={0.08} y={50} blur={16} scale={0.96} duration={1.0}>
        <Card
          index="01"
          tag="Computational Biology"
          title="Fibroid Knowledge Graph"
          subtitle="Evidence-attributed signaling network for uterine fibrosis"
          desc="An evidence-attributed interaction network of the signaling loop driving uterine fibroid formation."
          meta="Ongoing"
          img="/fibroid-graph.png"
          imgAlt="Signaling network graph of macrophages, fibroblasts, and smooth muscle cells"
          imgFit="contain"
        />
      </Reveal>
      ...
      <Reveal delay={0.24} y={44} blur={14} scale={0.97} duration={0.95}>
        <Card
          ...
          desc="A pipeline for benchmarking chromatin peak-calling methods on CUT&RUN data."
